...
{{ !isset($isBanner) ? 'iq-banner' : '' }} default">
    ...
    <!-- Backend flash: session keys pulled into JSON for backend-custom.js -->
    @php
        $__backendFlashPayload = [
    ...
    @endphp
    <script>
        window.__backendFlash = @json($__backendFlashPayload);
    </script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (form && submitButton && !form.classList.contains('short-drama-episode-form') && !form.classList.contains('short-drama-section-form') && !form.classList.contains('short-drama-drama-form')) {
            ...
            function validateVideoUrlInput() {
                ...
                if (videourl.value === '') {
                    ...
                    if (selectedValue === 'YouTube') {
                        ...
                        urlPattern = /^(https?:\/\/)?(www\.|player\.)?vimeo\.com\/.+$/;
                        urlPatternError.innerText = '';
                        urlPatternError.innerText = 'Please enter a valid Vimeo URL'
                    } else {
                        // General URL pattern for other types
