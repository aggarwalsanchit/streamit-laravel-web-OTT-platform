...
class UserController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        storeMediaFile($data, $request->file('profile_image'), 'profile_image', 'avatar');
    ...
    public function change_password(Request $request)
    {
        ...
        if (setting('demo_login') && $isDemoAdmin) {
    ...
    public function import(Request $request)
    {
        try {
            ...
            $file = validateUploadedFile($request->file('import_file'), 'import');
            $filename = sanitizeUploadedFilename($file, 'import');
