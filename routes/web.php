...
use App\Http\Controllers\Backend\ShortDramaPluginInstallerController;
...
Route::group(['prefix' => 'app', ['middleware' => ['auth','admin']]], function () {
    ...
    Route::group(['as' => 'backend.', 'middleware' => ['auth','admin']], function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::get('settings-data', [SettingController::class, 'index_data'])->name('settings-data');
    ...
    */
    Route::group(['as' => 'backend.', 'middleware' => ['auth','admin']], function () {
        ...
        Route::get('/get_revnue_chart_data/{type}', [BackendController::class, 'getRevenuechartData'])->name('get_revnue_chart_data');
        Route::get('/get_subscriber_chart_data/{type}', [BackendController::class, 'getSubscriberChartData'])->name('get_subscriber_chart_data');
        Route::get('/get_genre_chart_data', [BackendController::class, 'getGenreChartData'])->name('get_genre_chart_data');
        Route::get('/get_mostwatch_chart_data/{type}', [BackendController::class, 'getMostwatchChartData'])->name('get_mostwatch_chart_data');
        Route::get('/get_toprated_chart_data', [BackendController::class, 'getTopRatedChartData'])->name('get_toprated_chart_data');
        ...
        Route::get('app-configuration', [App\Http\Controllers\Backend\API\SettingController::class, 'appConfiguraton'])->name('app-configuration');
        Route::get('data-configuration', [App\Http\Controllers\Backend\API\SettingController::class, 'Configuraton'])->name('data-configuration');
...
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // ── Short Drama plugin installer (core app — runs before module is registered) ──
    Route::prefix('app/short-drama')
        ->middleware(['web', 'auth', 'admin'])
        ->as('backend.short-drama.')
        ->group(function () {
            Route::get('installer', [ShortDramaPluginInstallerController::class, 'index'])->name('installer');
            Route::post('installer/install', [ShortDramaPluginInstallerController::class, 'install'])->name('installer.install');
            Route::post('installer/uninstall', [ShortDramaPluginInstallerController::class, 'uninstall'])->name('installer.uninstall');
        });
