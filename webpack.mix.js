...
// ShortDrama watch player (separate bundle — only loaded on the watch page)
const shortDramaWatchJs = `${__dirname}/Modules/ShortDrama/Resources/assets/js/watch.js`
if (Fs.existsSync(shortDramaWatchJs)) {
  mix.js(shortDramaWatchJs, 'modules/shortdrama/watch.js').sourceMaps()
}
